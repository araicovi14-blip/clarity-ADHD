...
import { PHONE, EMAIL, INSTAGRAM, FACEBOOK, SITE_NAME, JANE_APP_URL } from '@/lib/constants'
...
export function Footer() {
  return (
    <footer className="bg-[#F2F2F0] border-t border-black/5">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          {/* Logo + tagline */}
          <div>
            <Link href="/" aria-label="Clarity ADHD Clinic — home" className="inline-block mb-5">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-[#6B7280] leading-relaxed pt-1 max-w-xs">
                Our phone is answered by Milly, our AI secretary.
                Tatjana responds within 24 hours.
              </p>
        ...
        <div className="mt-14 pt-8 border-t border-black/5 text-center">
          <p className="text-xs text-[#6B7280]">© 2025 {SITE_NAME}</p>
        </div>
      </div>
    </footer>
  )
